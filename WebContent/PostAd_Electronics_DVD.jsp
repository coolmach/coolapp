	...
	<s:form cssClass="form-horizontal post" action="dvd_postAd" enctype="multipart/form-data">
	   ...
	   <div class="col-md-8">
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" class="form-control" maxlength="200" id="Title" name="Title" value="Philips Blue Ray DVD Player available for Sale in Marathalli" required>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-6" style="padding-top:6px;">
					<input type="text" maxlength="15" class="form-control" name="brand" id="brand" value="Samsung" required>
				</div>
			</div>
			<div class="form-group">
				<label for="model" class="col-sm-4 control-label">Model</label>
				<div class="col-sm-6">
					<input type="text" maxlength="15" class="form-control" name="model" id="model" value="">
				</div>
			</div>
			<div class="form-group">
