...
<div class="col-md-8" style="border:1px solid #CCCCCC; margin-left:2%; width:63.5%;">
	<s:form cssClass="form-horizontal post" action="#">
	   ...
	   <div class="col-md-7">
			...
			<div class="form_Row">
				<label class="col-sm-5 control-label fieldCaption">Loading Type</label>
				<div class="col-sm-7">
					<label class="form-control-static"><s:property value="postDetails.loadingType"/></label>
				</div>	
			</div>
			<div class="form_Row">
				<label class="col-sm-5 control-label fieldCaption">Automatic Type</label>
				<div class="col-sm-7">
					<label class="form-control-static"><s:property value="postDetails.automaticType"/></label>
				</div>	
			</div>
		...
		<div class="col-md-5" style="margin-left:-10px;">
			...
			<s:if test="postDetails.capacity != ''">
			<div class="form_Row">
				<label class="col-sm-5 control-label fieldCaption">Capacity (in Kg)</label>
				<div class="col-sm-7">
					<label class="form-control-static"><s:property value="postDetails.capacity"/></label>
				</div>
			</div>
			</s:if>
		</div>
