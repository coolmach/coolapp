	...
	<s:form cssClass="form-horizontal post" action="#">
	   ...
	   <div class="col-md-7">
			...
			<div class="form_Row">
				...
				<div class="col-sm-7">
					<label class="form-control-static"><s:property value="postDetails.brand"/></label> 
				</div>
			</div>
			<div class="form_Row">
				<label class="col-sm-5 control-label fieldCaption">Camera Type</label>
				<div class="col-sm-7">
					<label class="form-control-static"><s:property value="postDetails.cameraType"/></label>
				</div>	
			</div>
			<div class="form_Row">
				<label class="col-sm-5 control-label fieldCaption">Age In Years</label>
				<div class="col-sm-7">
					<label class="form-control-static">
						<s:if test="postDetails.year == \"0.5\"">&lt; 1 year</s:if>
						<s:elseif test="postDetails.year == \"1.5\"">1 -2 years</s:elseif>
						<s:elseif test="postDetails.year == \"2.5\"">2 - 3 years</s:elseif>
						<s:elseif test="postDetails.year == \"3.5\"">3 - 4 years</s:elseif>
						<s:elseif test="postDetails.year == \"4.5\"">4 - 5 years</s:elseif>
						<s:elseif test="postDetails.year == \"5.5\"">&gt; 5 years</s:elseif>
					</label>
				</div>	
			</div>
			<div class="form_Row">
		...
		<div class="col-md-5" style="margin-left:-10px;">
			...
			<s:if test="postDetails.resolution != ''">
			<div class="form_Row">
				<label class="col-sm-5 control-label fieldCaption">Resolution</label>
				<div class="col-sm-7">
					<label class="form-control-static"><s:property value="postDetails.resolution"/></label>
				</div>
			</div>
			</s:if>
			<s:if test="postDetails.zoom != ''">
			<div class="form_Row">
				<label class="col-sm-5 control-label fieldCaption">Zoom (in X)</label>
				<div class="col-sm-7">
					<label class="form-control-static"><s:property value="postDetails.zoom"/></label>
				</div>
			</div>
			</s:if>
		</div>
