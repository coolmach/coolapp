...
<div class="col-md-11" style="border:1px solid #CCCCCC; margin-left:2.5%;">
	<s:form cssClass="form-horizontal post" action="#">
	   ...
	   <div class="col-md-7">
			...
			<div class="form_Row">
				<label class="col-sm-5 control-label fieldCaption">AC Type</label>
				<div class="col-sm-7">
					<label class="form-control-static"><s:property value="postDetails.acType"/></label>
				</div>	
			</div>										
			<div class="form_Row">
		...
		<div class="col-md-5" style="margin-left:-10px;">
			...
			<s:if test="postDetails.tonnage != ''">
			<div class="form_Row">
				<label class="col-sm-5 control-label fieldCaption">No. of Tons</label>
				<div class="col-sm-7">
					<label class="form-control-static"><s:property value="postDetails.tonnage"/></label>
				</div>
			</div>
			</s:if>
