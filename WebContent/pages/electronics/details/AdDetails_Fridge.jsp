...
<div class="col-md-8" style="border:1px solid #CCCCCC; margin-left:2%; width:63.5%;">
	<s:form cssClass="form-horizontal post" action="#">
	   ...
	   <div class="col-md-7">
			...
			<div class="form_Row">
				<label class="col-sm-5 control-label fieldCaption">No. of Doors</label>
				<div class="col-sm-7">
					<label class="form-control-static">
						<s:if test="postDetails.doubleDoor == \"Y\"">
							Double Door
						</s:if>
						<s:else>
							Single Door
		...
		<div class="col-md-5" style="margin-left:-10px;">
			...
			<div class="form_Row">
				<label class="col-sm-5 control-label fieldCaption">Capacity (litres)</label>
				<div class="col-sm-7">
