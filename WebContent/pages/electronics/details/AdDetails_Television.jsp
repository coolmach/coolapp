...
<div class="col-md-8" style="border:1px solid #CCCCCC; margin-left:2%; width:63.5%;">
	<s:form cssClass="form-horizontal post" action="#">
	   ...
	   <div class="col-md-7">
			...
			<div class="form_Row">
				<label class="col-sm-5 control-label fieldCaption">Screen Type</label>
				<div class="col-sm-7">
					<label class="form-control-static"><s:property value="postDetails.screenType"/></label>
				</div>	
			</div>
			<div class="form_Row">
		...
		<div class="col-md-5" style="margin-left:-10px;">
			...
			<s:if test="postDetails.screenSize != ''">
			<div class="form_Row">
				<label class="col-sm-5 control-label fieldCaption">Screen Size</label>
				<div class="col-sm-7">
					<label class="form-control-static"><s:property value="postDetails.screenSize"/></label>
				</div>
			</div>
			</s:if>
			<s:if test="postDetails.zoom != ''">
			<div class="form_Row">
				<label class="col-sm-5 control-label fieldCaption">Stabilizer Available</label>
				<div class="col-sm-7">
					<label class="form-control-static">
						<s:if test="postDetails.stabilizer == \"Y\"">
							Yes
						</s:if>
						<s:else>
							No
