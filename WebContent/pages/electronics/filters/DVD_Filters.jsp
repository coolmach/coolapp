	...
	<!--s:if test="adList.size() > 0"-->
		<div class="col-md-12 filter_cat">
			<form class="form-inline" id="mobile">
				...
				<div class=" pull-left hidden-subcat searchFilter" id="playerType-main">
					<div id="os" class="inputstyle pointer form-control">Player Type <span class="glyphicon glyphicon glyphicon-chevron-down form-control-show"></span></div>
					<div id="subCategory_hidden_playerType" class="subCategory_hidden_bck" style="display: none;">
						<ul class="dropdown-menu scrollable-menu" role="menu">
						    <li><input type="checkbox" class="check_playerType" name="playerType" value="DVD" /><span class="content">DVD</span></li>
						    <li><input type="checkbox" class="check_playerType" name="playerType" value="MP3" /><span class="content">MP3</span></li>
							<li><input type="checkbox" class="check_playerType" name="playerType" value="iPod" /><span class="content">iPod</span></li>
							<li><input type="checkbox" class="check_playerType" name="playerType" value="Others" /><span class="content">Others</span></li>
						</ul>
						<a href="#" class="clear blue_link">clear filters</a>
					</div>
				</div>
