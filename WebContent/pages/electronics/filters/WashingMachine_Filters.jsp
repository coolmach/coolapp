	...
	<s:if test="adList.size() > 0">
		<div class="col-md-12 filter_cat">
			<form class="form-inline" id="mobile">
				...
				<div class=" pull-left hidden-subcat searchFilter" id="automaticType-main">
					<div id="os" class="inputstyle pointer form-control">Automatic Type <span class="glyphicon glyphicon glyphicon-chevron-down form-control-show"></span></div>
					<div id="subCategory_hidden_automaticType" class="subCategory_hidden_bck" style="display: none;">
						<ul class="dropdown-menu scrollable-menu" role="menu">
						    <li><input type="checkbox" class="check_automaticType" name="automaticType" value="Fully Automatic" /><span class="content">Fully Automatic</span></li>
						    <li><input type="checkbox" class="check_automaticType" name="automaticType" value="Semi Automatic" /><span class="content">Semi Automatic</span></li>
							<li><input type="checkbox" class="check_automaticType" name="automaticType" value="Manual" /><span class="content">Manual</span></li>
						</ul>
						<a href="#" class="clear blue_link">clear filters</a>
					</div>
				</div>
				<div class=" pull-left hidden-subcat searchFilter" id="loadingType-main">
					<div id="os" class="inputstyle pointer form-control">Loading Type <span class="glyphicon glyphicon glyphicon-chevron-down form-control-show"></span></div>
					<div id="subCategory_hidden_loadingType" class="subCategory_hidden_bck" style="display: none;">
						<ul class="dropdown-menu scrollable-menu" role="menu">
						    <li><input type="checkbox" class="check_loadingType" name="loadingType" value="Front" /><span class="content">Front Load</span></li>
						    <li><input type="checkbox" class="check_loadingType" name="loadingType" value="Top" /><span class="content">Top Load</span></li>
							<li><input type="checkbox" class="check_loadingType" name="loadingType" value="Others" /><span class="content">Others</span></li>
						</ul>
						<a href="#" class="clear blue_link">clear filters</a>
					</div>
				</div>
