		...
		<div class="col-md-12 filter_cat">
			<form class="form-inline" id="mobile">
				<div class=" pull-left hidden-subcat searchFilter" id="brand-main">
					...
					<div id="subCategory_hidden_brand" class="subCategory_hidden_bck" style="display: none;">
						<ul class="dropdown-menu scrollable-menu" role="menu">
							<li><input type="checkbox" class="check_brand" name="brand" value="Bluestar" /><span class="content">Bluestar</span></li>
							...
							<li><input type="checkbox" class="check_brand" name="brand" value="Voltas" /><span class="content">Voltas</span></li>
				...
				<div class=" pull-left hidden-subcat searchFilter" id="acType-main">
					<div id="os" class="inputstyle pointer form-control">AC Type <span class="glyphicon glyphicon glyphicon-chevron-down form-control-show"></span></div>
					<div id="subCategory_hidden_acType" class="subCategory_hidden_bck" style="display: none;">
						<ul class="dropdown-menu scrollable-menu" role="menu">
						    <li><input type="checkbox" class="check_acType" name="acType" value="Window AC" /><span class="content">Window AC</span></li>
						    <li><input type="checkbox" class="check_acType" name="acType" value="Split AC" /><span class="content">Split AC</span></li>
							<li><input type="checkbox" class="check_acType" name="acType" value="Air Cooler" /><span class="content">Air Cooler</span></li>
						</ul>
						<a href="#" class="clear blue_link">clear filters</a>
					</div>
				</div>
