				...
				<tr style="font-size:12px;">
					 ...
					 <td>
						<p style="color:#428bca;font-size:14px;">
							<a
								href="<s:url action="dvdAdDetails" escapeAmp="false"> 
						...
						<br>
						<span class="postField"><s:property value="playerType" /></span>
						...
						<br>
						<span class="postField">Bought:&nbsp;On&nbsp;<s:property value="year" /></span><span class="separator">|</span> 
						<br>
					</td>
					<td>
