				...
				<tr style="font-size:12px;">
					 ...
					 <td>
						<p style="color:#428bca;font-size:14px;">
							<a
								href="<s:url action="televisionAdDetails" escapeAmp="false"> 
						...
						<span class="postField"><s:property value="screenType" />&nbsp;TV</span> <span class="separator">|</span>
						<span class="postField">Bought:&nbsp;On&nbsp;<s:property value="year" /></span>
						<s:if test="%{hdmi == Y}">
						<br>
						<span class="postField">HDMI&nbsp;Port</span> <span class="separator">|</span>
						</s:if> 		
						<br>
					</td>
					<td>
