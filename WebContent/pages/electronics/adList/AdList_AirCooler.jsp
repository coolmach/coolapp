		...
		<div class="col-md-8 listSection" id="postListSection" style="margin-left:5px;">
			...
			<table class="table table-bordered">
				...
				<s:iterator value="adList" status="userStatus">
					...
					<tr class="postRow" style="font-size: 12px;" onclick="showDetails('airCoolerAdDetails', 'ELEC', '<s:property value="%{subCategory}"/>', '<s:property value="%{postId}"/>')">
						<td style="width: 25%;">
						...
						<td style="width:45%;">
							...
							<span class="postField"><B><s:property value="airCoolerType" /></B>
							</span>
							<br>
