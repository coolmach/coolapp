...
<div class="col-md-8" id="my">
	<s:form cssClass="form-horizontal post" action="airCooler_postAd" enctype="multipart/form-data">
	   ...
	   <div class="col-md-8">
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" class="form-control" maxlength="200" id="Title" name="Title" value="Panasonic 1 Ton AC available for sale" required>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-6" style="padding-top:6px;">
					<input type="text" maxlength="15" class="form-control" name="brand" id="brand" value="Panasonic" required>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label for="tonnage" class="col-sm-4 control-label">Number of Tons</label>
				<div class="col-sm-3">
					<input type="text" maxlength="4" class="form-control" name="tonnage" id="tonnage" value="1.5">
				</div>
			</div>
			<div class="form-group">
				<label for="acType" class="col-sm-4 control-label">AC Type<span class="mandatory">*</span></label>
				<div class="col-sm-6">
					<input type="radio" class="form-control-radio" name="acType" id="acType" value="Split"> <span class="form-control-radio-label">Split AC</span>
					<input type="radio" class="form-control-radio" name="acType" id="acType" value="Window"> <span class="form-control-radio-label">Window AC</span>
				</div>
			</div>											
			<div class="form-group">
