	...
	<div>
		...
		<div>
			<div class="form-group">
				<label for="furnished" class="col-sm-3 control-label">AC Type<span class="mandatory">*</span></label>
				<div class="col-sm-6">
					<s:select class="dropDown" style="height:30px;width:120px;" id="acType" name="acType" theme="simple"
						headerKey="-1" headerValue="Select"
						list="#{'Window AC':'Window AC', 'Split AC':'Split AC', 'Air Cooler':'Air Cooler'}"
						value="acType" />
					<div class="fieldTip" id="acTypeTip"></div>
					<div class="fieldTip" id="acType_Error"></div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-3" style="padding-top:6px;">
					<s:select class="dropDown" style="height:30px;width:120px;" id="brand" name="brand" theme="simple"
						headerKey="-1" headerValue="Select"
						list="#{'Bluestar':'Bluestar','Godrej':'Godrej','Onida':'Onida','LG':'LG','Panasonic':'Panasonic','Samsung':'Samsung','Voltas':'Voltas','Whirlpool':'Whirlpool','Videocon':'Videocon','Others':'Others'}" 
						value="brand" />				
		...
		<div id="collapse_section_1" class="collapse">
			...
			<div class="form-group">
				<label class="col-sm-3 control-label">No. of Tons</label>
				<div class="col-sm-3">
					<input type="text" class="form-control" maxlength="4" name="tonnage" id="tonnage" value='<s:property value="tonnage"/>' 
					data-validate-type="floatingPoint" data-validate-errMessage="Please enter valid Tonnage" data-infoTip="Please enter the Capacity">
					<div class="fieldTip" id="tonnageTip"></div>
					<div class="fieldTip" id="tonnage_Error"></div>
				</div>
			</div>
			<div class="form-group">
...
<script>
	...
	function isAnyAdditionalDetailPopulated(){
		output = false;
		if(isTextFieldPopulated("model", "tonnage", "Description")){
			output = true;
		}
...
function localValidations(){
	...
	if($("#acType").val() == "-1"){
		showOrHideErrorTip(false, "acType", "Please choose the AC Type");
		return false;
	}
