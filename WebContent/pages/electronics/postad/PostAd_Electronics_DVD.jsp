	...
	<div>
		...
		<div>
			<div class="form-group">
				...
				<div class="form-group">
					<label for="furnished" class="col-sm-3 control-label">Type<span class="mandatory">*</span></label>
					<div class="col-sm-6">
						<s:select class="dropDown" style="height:30px;width:120px;" id="playerType" name="playerType" theme="simple"
							headerKey="-1" headerValue="Select"
							list="#{'DVD':'DVD', 'MP3':'MP3', 'iPod':'iPod'}"
							value="playerType" />
						<div class="fieldTip" id="playerTypeTip"></div>
						<div class="fieldTip" id="playerType_Error"></div>
					</div>
				</div>				
				<div class="col-sm-3" style="padding-top:6px;">
					<s:select class="dropDown" style="height:30px;width:120px;" id="brand" name="brand" theme="simple"
						headerKey="-1" headerValue="Select"
						list="#{'Apple':'Apple','Akai':'Akai','LG':'LG','Onida':'Onida','Panasonic':'Panasonic','Philips':'Philips','Samsung':'Samsung','Sansui':'Sansui','Sharp':'Sharp','Sony':'Sony','Toshiba':'Toshiba','Videocon':'Videocon','Others':'Others'}" 
						value="brand" />				
...
function localValidations(){
	...
	if($("#playerType").val() == "-1"){
		showOrHideErrorTip(false, "playerType", "Please choose Player Type");
		return false;
	}
	if($("#year").val() == "-1"){
