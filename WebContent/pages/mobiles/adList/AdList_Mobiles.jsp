		...
		<div class="col-md-8 listSection" id="postListSection" style="margin-left:5px;">
			...
			<table class="table table-bordered">
				...
				<s:iterator value="adList" status="userStatus">
					...
					<tr class="postRow" style="font-size: 12px;" onclick="showDetails('mobilesAdDetails', 'MOBILE', '<s:property value="%{subCategory}"/>', '<s:property value="%{postId}"/>')">
						<td style="width: 25%;">
						...
						<td style="width:45%;">
							...
							<s:if test="%{subCategory == 1}">
								...
								<span class="postField">Touch&nbsp;Screen:
									<s:if test="touchScreen == Y">
										Yes
									</s:if>
									<s:else>
										No
							...
							<s:elseif test="%{subCategory == 2}">
								<!-- Accessories -->
								<br>
								<span class="postField"><s:property value="accessoryType" /></span>
								<br>
							</s:elseif> 
