	...
	<s:form cssClass="form-horizontal post" action="#">
	   ...
	   <div class="col-md-7">
		...
		<div class="col-md-5" style="margin-left:-10px;">
			...
			<div class="form_Row">
				<label class="col-sm-5 control-label fieldCaption">Sim Type</label>
				<div class="col-sm-7">
					<label class="form-control-static">
						<s:if test="postDetails.dualSim == \"Y\"">
							Dual Sim
						</s:if>
						<s:else>
							Single Sim
			...
			<div class="form_Row">
				<label class="col-sm-5 control-label fieldCaption">Touch</label>
				<div class="col-sm-7">
					<label class="form-control-static">
						<s:if test="postDetails.touchScreen == \"Y\"">
							Touch Screen
						</s:if>
						<s:else>
							Non-touch Screen
			...
			<s:if test="postDetails.operatingSystem != null">
			<div class="form_Row">
				<label class="col-sm-5 control-label fieldCaption">OS</label>
				<div class="col-sm-7">
					<label class="form-control-static"><s:property value="postDetails.operatingSystem"/></label>
				</div>
			</div>
			</s:if>
			<s:if test="postDetails.year != 0">
			<div class="form_Row">
				<label class="col-sm-5 control-label fieldCaption">Year</label>
				<div class="col-sm-7">
					<label class="form-control-static"><s:property value="postDetails.year"/></label>
				</div>
			</div>
			</s:if>
			<s:if test="postDetails.color != null">
			<div class="form_Row">
