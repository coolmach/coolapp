		...
		<div class="col-md-12 listSection" id="postListSection" style="margin-left:5px;">
			...
			<table class="table table-bordered">
				...
				<s:iterator value="adList" status="userStatus">
					...
					<tr class="postRow" style="font-size: 12px;" onclick="showDetails('furnitureAdDetails', 'FURN', '<s:property value="%{subCategory}"/>', '<s:property value="%{postId}"/>')">
						<td style="width: 25%;">
						...
						<td style="width:45%;">
							...
							<!--s:if test="%{subCategory == 1}"-->
								<br>
								<span class="postField"><B><s:property value="furnitureTypeStr" /></B></span><span class="separator">|</span>
