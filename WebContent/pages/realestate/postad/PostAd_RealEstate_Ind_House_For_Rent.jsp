<%@ taglib prefix="s" uri="/struts-tags"%>
	...
	<div id="APARTMENT_FOR_RENT">
		...
		<div>
			<div class="form-group">
				...
				<div class="col-sm-2">
					<s:select class="dropDown" style="height:30px;width:100px;" id="Bedrooms" name="Bedrooms" theme="simple"
						headerKey="-1" headerValue="Select"
						list="#{'1':'1', '2':'2', '2.5':'2.5', '3':'3', '4':'4', 'Studio':'Studio', 'Single':'Single Room'}"
						value="Bedrooms" />			
				</div>
			</div>
			<div class="form-group">
	...
	function isAnyAdditionalDetailPopulated(){
		output = false;
		if(isTextFieldPopulated("sdeposit") || isTextFieldPopulated("smaintenance")){
			output = true;
		}
		//alert("1 - " + output);
