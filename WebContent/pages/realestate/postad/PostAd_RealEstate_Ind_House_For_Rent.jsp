	...
	<s:form cssClass="form-horizontal post" action="real_estate_postAd.action" enctype="multipart/form-data">
	   ...
	   <div class="col-md-8">
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input type="radio" class="form-control-radio" name="carParking" id="carParking" value="Y"> <span class="form-control-radio-label">Yes</span>
					<input type="radio" class="form-control-radio" name="carParking" id="carParking" value="N"> <span class="form-control-radio-label">No</span>
				</div>
			</div>
			<div class="form-group">
