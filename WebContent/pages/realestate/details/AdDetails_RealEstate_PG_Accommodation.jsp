	...
	<s:form cssClass="form-horizontal post" action="#">
	   ...
	   <div class="col-md-7">
		...
		<div class="col-md-5" style="margin-left:-10px;">
			...
			<div class="form_Row">
				<label class="col-sm-5 control-label fieldCaption">PG Name</label>
				<div class="col-sm-7">
			...
			<div class="form_Row">
				<label class="col-sm-5 control-label fieldCaption">Food</label>
				<div class="col-sm-7">
					<label class="form-control-static">Will be provided</label>
				</div>
			</div>
			</s:if>				
			<s:if test="postDetails.powerBackup == \"Y\" || postDetails.gym == \"Y\" || postDetails.wifi == \"Y\" || postDetails.carParking == \"Y\"">
			<div class="form_Row">
