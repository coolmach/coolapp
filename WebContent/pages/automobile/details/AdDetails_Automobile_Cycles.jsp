			...
			<div class="form_Row">
				...
				<div class="col-sm-7">
					<label class="form-control-static">
						<s:if test="postDetails.year == \"1\"">Less than 1 year old</s:if>
						<s:elseif test="postDetails.year == \"2\"">1 -2 years old</s:elseif>
						<s:elseif test="postDetails.year == \"3\"">2 - 3 years old</s:elseif>
						<s:elseif test="postDetails.year == \"4\"">3 - 4 years old</s:elseif>
						<s:elseif test="postDetails.year == \"5\"">4 - 5 years old</s:elseif>
						<s:elseif test="postDetails.year == \"6\"">Older than 5 years</s:elseif>
					</label>
				</div>	
			</div>			
			<div class="form_Row">
