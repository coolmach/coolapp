...
<div class="col-md-11" style="border:1px solid #CCCCCC; margin-left:2.5%;">
	<s:form cssClass="form-horizontal post" action="#">
	   ...
	   <div class="col-md-7">
			...
			<div class="form_Row">
				<label class="col-sm-5 control-label fieldCaption">Fuel Type</label>
				<div class="col-sm-7">
					<label class="form-control-static"><s:property value="postDetails.fuelType"/></label>
				</div>
			</div>			
			<div class="form_Row">
			...
			<div class="form_Row">
				...
				<div class="col-sm-7">
					<label class="form-control-static">
						<s:if test="postDetails.year == 1">
							Not Specified
						</s:if>
						<s:elseif test="postDetails.year == 2">
							Older than 2000
						</s:elseif>
						<s:else>
							<s:property value="postDetails.year"/>
						</s:else>
					</label>
				</div>	
			</div>
