		...
		<div id="main_left">
			...
			<div id="icons_row">
				<div class="icon" id="tile1">
					<a href="/Virat/realestate?category=REAL&amp;subCategory=1&amp;city=BLR">
				...
				<div class="icon" id="tile2">
					<a href="/Virat/automobile?category=AUTO&amp;subCategory=1&amp;city=BLR">
				...
				<div class="icon" id="tile3">
					<a href="/Virat/electronics?category=ELEC&amp;subCategory=0&amp;city=BLR">
				...
				<div class="icon" id="tile4">
					<a href="/Virat/mobiles?category=MOBILE&amp;subCategory=1&amp;city=BLR">
				...
				<div class="icon" id="tile5">
					<a href="/Virat/computers?category=COMP&amp;subCategory=1&amp;city=BLR">
				...
				<div class="icon" id="tile6">
					<a href="/Virat/furniture?category=FURN&amp;city=BLR">
...
function searchPosts(){
	...
	if(keyword != ""){
		...
		window.location.href = baseUrl + "/searchPosts?" + "searchKeyword=" + keyword + "&city=BLR";	
	}else{
		$("#item_search").focus();
	}
}
