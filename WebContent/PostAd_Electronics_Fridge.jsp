...
<div class="col-md-8" id="my">
	<s:form cssClass="form-horizontal post" action="fridge_postAd" enctype="multipart/form-data">
	   ...
	   <div class="col-md-8">
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" class="form-control" maxlength="200" id="Title" name="Title" value="LG Fridge (165 l) for sale" required>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-6" style="padding-top:6px;">
					<input type="text" maxlength="15" class="form-control" name="brand" id="brand" value="LG" required>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
					<input type="text" maxlength="8" class="form-control" name="color" id="color" value="135">
				</div>
			</div>
			<div class="form-group">
				<label for="capacity" class="col-sm-4 control-label">Capacity (in litres)</label>
				<div class="col-sm-3">
					<input type="text" maxlength="6" class="form-control" name="capacity" id="capacity" value="3.2">
				</div>
			</div>
			<div class="form-group">
				<label for="doubleDoor" class="col-sm-4 control-label">Number of Doors<span class="mandatory">*</span></label>
				<div class="col-sm-6">
					<input type="radio" class="form-control-radio" name="doubleDoor" id="doubleDoor" value="N"> <span class="form-control-radio-label">1</span>
					<input type="radio" class="form-control-radio" name="doubleDoor" id="doubleDoor" value="Y"> <span class="form-control-radio-label">2</span>
				</div>
			</div>												
			<div class="form-group">
