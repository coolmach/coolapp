<div class=" header_2">
	<div class="col-md-12 filter_cat" style="margin-top:3.86%;">
	 ...
	 <form class="form-inline" id="television"> 
			...
			<div class=" pull-left hidden-subcat searchFilter" id="screenType-main">
				...
				<div id="subCategory_hidden_makeBikes" class="subCategory_hidden_bck">
					<ul class="list-unstyled">
			...
			<div class=" pull-left hidden-subcat searchFilter" id="amt-main">
				...
				<div id="subCategory_hidden_amt" class="subCategory_hidden_bck">
					<ul class="list-unstyled">
					    <li><input type="checkbox" class="check_amt" name="amt" value="<2000" /><span class="content"><2,000</span></li>
						<li><input type="checkbox" class="check_amt" name="amt" value="20000-5000" /><span class="content">2,000 - 5,0000</span></li>
						<li><input type="checkbox" class="check_amt" name="amt" value="5000-10000" /><span class="content">5,000 - 10,000</span></li>
	...
	<a class="grey_link" href="<s:url action=""  />">Home</a> >
		...
		<span id="breadCrumb_SubCategory">Television</span>
	</div>
</div>