...
<div class="col-md-8" id="my">
	<s:form cssClass="form-horizontal post" action="furniture_postAd" enctype="multipart/form-data">
	   ...
	   <div class="col-md-8">
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" class="form-control" maxlength="200" id="Title" name="Title" value="Used Dining Table For Sale" required>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-6" style="padding-top:6px;">
					<select class="dropDown" name="type" id="type">
						...
						<option value="COT_WOOD">Cot - Wooden</option> 
						<option value="COT_STEEL">Cot - Steel</option>  
						<option value="MATTRESS">Mattress</option>
						<option value="TABLE">Table</option> 
						<option value="TV">TV Stand</option>
						<option value="SHOE">Shoe Rack</option> 
						<option value="DINING">Dining Table</option>
						<option value="CHAIR_WOOD">Chair - Wood</option>
						<option value="CHAIR_PLASTIC">Chair - Plastic</option> 
			...
			<div class="form-group">
				<label for="year" class="col-sm-4 control-label">Year of purchase</label>
				<div class="col-sm-3">
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
					<input type="text" maxlength="6" class="form-control" name="price" id="price" value="15000" required>
				</div>
			</div>
			<div class="form-group">
				<label for="description" class="col-sm-4 control-label">Description</label>
				<div class="col-sm-8">
					<textarea class="form-control" maxlength="256" rows="3" name="Description" id="Description" placeholder="Please enter some information about the furniture"></textarea>
				</div>
			</div>
			<div class="form-group">
