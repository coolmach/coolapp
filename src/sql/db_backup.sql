...
INSERT INTO `post_details_dvd` VALUES (148,'BLR','54','Philips','',0,30000,'N','2014-07-15 19:59:37','6','2014-07-15 19:59:37','6'),(149,'BLR','54','Philips','2010',0,30000,'Y','2014-07-15 20:00:15','6','2014-07-15 20:00:15','6'),(150,'CHE','C80','Philips','MODEL',0,30000,'N','2014-07-15 20:02:54','6','2014-07-15 20:02:54','6'),(151,'CHE','C80','Philips','INRT32',2010,35000,'Y','2014-07-15 20:06:57','6','2014-07-15 20:06:57','6');
...
INSERT INTO `post_details_washingmachine` VALUES (159,'BLR','108','Onida','25 TW',2007,30000,'N','2014-07-15 20:37:26','6','2014-07-15 20:37:26','6');
...
INSERT INTO `user_credentials` VALUES ('0',1,'shiva@infosys.com','test23','9999999999','0',NULL,NULL,'2014-06-22 11:09:22','SYSTEM','2014-06-22 11:09:22','SYSTEM'),('0',2,'sachin@corporate.com','test','9999977777','0',NULL,NULL,'2014-06-22 11:41:50','SYSTEM','2014-06-22 11:41:50','SYSTEM'),('0',3,'yoganand@cts.com','test123','9999911111','0','2014-06-26 21:40:54',NULL,'2014-06-22 11:46:44','SYSTEM','2014-06-26 21:40:54','3'),('0',4,'iiii@gmail.ccom','test','1231221232','0',NULL,NULL,'2014-06-22 13:48:03','SYSTEM','2014-06-22 13:48:03','SYSTEM'),('0',5,'gopi@tcs.com','test','9999944444','0',NULL,NULL,'2014-06-27 07:58:56','SYSTEM','2014-06-27 07:58:56','SYSTEM'),('0',6,'julies@cts.com','test','9999922222','0','2014-07-16 02:15:48',NULL,'2014-06-30 06:30:04','SYSTEM','2014-07-16 02:15:48','6');
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`shiva`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `pdvd` AS select `post_details_dvd`.`POST_ID` AS `POST_ID`,`post_details_dvd`.`CITY` AS `CITY`,`post_details_dvd`.`LOCATION` AS `LOCATION`,`post_details_dvd`.`BRAND` AS `BRAND`,`post_details_dvd`.`MODEL` AS `MODEL`,`post_details_dvd`.`YEAR` AS `YEAR`,`post_details_dvd`.`PRICE` AS `PRICE`,`post_details_dvd`.`BILL_AVAILABLE` AS `BILL_AVAILABLE`,`post_details_dvd`.`CREATED_ON` AS `CREATED_ON`,`post_details_dvd`.`CREATED_BY` AS `CREATED_BY`,`post_details_dvd`.`MODIFIED_ON` AS `MODIFIED_ON`,`post_details_dvd`.`MODIFIED_BY` AS `MODIFIED_BY` from `post_details_dvd` */;
...
-- Dump completed on 2014-07-15 20:51:56
