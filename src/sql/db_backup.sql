...
INSERT INTO `mobile_master` VALUES ('100','Nokia','L520','Lumia 520','Y','Y',4.5,2,'Windows 8.1','Y','N','Y','2.1','3','2014-07-07 00:48:22','MANUAL','2014-07-07 00:48:22','MANUAL'),('101','Sony','1','Ericsson 14','Y','Y',4.5,2,'Android 4.3','Y','N','Y','2.1','3','2014-07-07 00:49:06','MANUAL','2014-07-07 00:49:06','MANUAL'),('102','Samsung','A1','Galaxy ABC','Y','Y',3.2,3,'Android 3.2','Y','N','Y','2.1','4','2014-07-08 16:18:24','SYSTEM','2014-07-08 16:18:24','SYSTEM');
...
INSERT INTO `post_details_mobile` VALUES ('125','1','BLR','46','NOK','L520',NULL,30000,2007,NULL,0,0,'Black',NULL,NULL,NULL,NULL,NULL,NULL,'2014-07-08 18:49:15','6','2014-07-08 18:49:15','6'),('126','1','BLR','46','NOK','L520',NULL,30000,2007,NULL,0,0,'Black',NULL,NULL,NULL,NULL,NULL,NULL,'2014-07-08 18:50:02','6','2014-07-08 18:50:02','6'),('127','1','BLR','C60','SON','L520',NULL,30000,2007,NULL,0,0,'Black',NULL,NULL,NULL,NULL,NULL,NULL,'2014-07-08 18:52:48','6','2014-07-08 18:52:48','6'),('128','1','CHE','C3','SAM','A1',NULL,30000,2007,NULL,0,0,'Black',NULL,NULL,NULL,NULL,NULL,NULL,'2014-07-08 19:06:39','6','2014-07-08 19:06:39','6'),('129','1','BLR','143','NOK','L520',NULL,30000,2007,NULL,0,0,'Black',NULL,NULL,NULL,NULL,NULL,NULL,'2014-07-08 19:15:32','6','2014-07-08 19:15:32','6'),('130','1','BLR','40','OTH','',NULL,30000,2007,NULL,0,0,'Black',NULL,NULL,NULL,NULL,NULL,NULL,'2014-07-08 19:21:31','6','2014-07-08 19:21:31','6'),('131','1','BLR','40','OTH','test',NULL,30000,2007,NULL,0,0,'Black',NULL,NULL,NULL,NULL,NULL,NULL,'2014-07-08 19:24:10','6','2014-07-08 19:24:10','6'),('132','1','BLR','84','NOK','L520',NULL,30000,2007,NULL,0,0,'Black',NULL,NULL,NULL,NULL,NULL,NULL,'2014-07-08 19:30:40','6','2014-07-08 19:30:40','6'),('133','1','BLR','84','SAM','A1',NULL,30000,2007,NULL,0,0,'Black',NULL,NULL,NULL,NULL,NULL,NULL,'2014-07-08 19:31:32','6','2014-07-08 19:31:32','6'),('134','1','BLR','84','Samsung','A1','Y',30000,2007,'Y',3.2,3,'Black','Android 3.2','Y','N','Y','2.1','4','2014-07-08 19:33:23','6','2014-07-08 19:33:23','6'),('135','1','BLR','83','Nokia','L520','Y',30000,2007,'Y',4.5,2,'Black','Windows 8.1','Y','N','Y','2.1','3','2014-07-08 19:56:36','6','2014-07-08 19:56:36','6');
...
INSERT INTO `user_credentials` VALUES ('0',1,'shiva@infosys.com','test23','9999999999','0',NULL,NULL,'2014-06-22 11:09:22','SYSTEM','2014-06-22 11:09:22','SYSTEM'),('0',2,'sachin@corporate.com','test','9999977777','0',NULL,NULL,'2014-06-22 11:41:50','SYSTEM','2014-06-22 11:41:50','SYSTEM'),('0',3,'yoganand@cts.com','test123','9999911111','0','2014-06-26 21:40:54',NULL,'2014-06-22 11:46:44','SYSTEM','2014-06-26 21:40:54','3'),('0',4,'iiii@gmail.ccom','test','1231221232','0',NULL,NULL,'2014-06-22 13:48:03','SYSTEM','2014-06-22 13:48:03','SYSTEM'),('0',5,'gopi@tcs.com','test','9999944444','0',NULL,NULL,'2014-06-27 07:58:56','SYSTEM','2014-06-27 07:58:56','SYSTEM'),('0',6,'julies@cts.com','test','9999922222','0','2014-07-09 01:23:34',NULL,'2014-06-30 06:30:04','SYSTEM','2014-07-09 01:23:34','6');
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`shiva`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `mobile_posts` AS select `pdmo`.`post_id` AS `post_id`,`pdmo`.`sub_category` AS `sub_category`,`pdmo`.`city` AS `city`,`pdmo`.`location` AS `location`,`pdmo`.`brand` AS `brand`,`pdmo`.`model` AS `model`,`pdmo`.`smart_phone` AS `smart_phone`,`pdmo`.`price` AS `price`,`pdmo`.`year` AS `year`,`pdmo`.`touch_screen` AS `touch_screen`,`pdmo`.`screen_size` AS `screen_size`,`pdmo`.`camera_resolution` AS `camera_resolution`,`pdmo`.`color` AS `color`,`pdmo`.`operating_system` AS `operating_system`,`pdmo`.`wi_fi` AS `wi_fi`,`pdmo`.`front_camera` AS `front_camera`,`pdmo`.`fm_radio` AS `fm_radio`,`pdmo`.`processor_speed` AS `processor_speed`,`pdmo`.`memory_size` AS `memory_size`,`pdmo`.`created_on` AS `created_on`,`pdmo`.`created_by` AS `created_by`,`pdmo`.`modified_on` AS `modified_on`,`pdmo`.`modified_by` AS `modified_by`,`poit`.`TITLE` AS `title`,`poit`.`CONTACT_NO` AS `contact_no`,`poit`.`CONTACT_PERSON_NAME` AS `contact_person_name`,`poit`.`DESCRIPTION` AS `description`,`poit`.`IMAGE_FILE_NAME` AS `image_file_name`,`poit`.`CORP_ID` AS `corp_id` from (`pdmo` join `poit`) where (`pdmo`.`post_id` = `poit`.`POST_ID`) */;
...
-- Dump completed on 2014-07-08 20:02:50
