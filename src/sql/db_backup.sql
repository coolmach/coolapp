...
INSERT INTO `post_details_furniture` VALUES (163,'1','BLR','68','DINING',2007,15000,'2014-07-17 19:14:18','6','2014-07-17 19:14:18','6'),(164,'1','BLR','68','DINING',2007,15000,'2014-07-17 19:14:53','6','2014-07-17 19:14:53','6'),(165,'1','BLR','68','DINING',2007,15000,'2014-07-17 19:16:07','6','2014-07-17 19:16:07','6'),(166,'1','CHE','C53','TV',2007,15000,'2014-07-17 19:36:57','6','2014-07-17 19:36:57','6');
...
INSERT INTO `post_details_television` VALUES (152,'BLR','46','Toshiba','25 TW',2007,10000,'N','CRT','20','N','Y','N','2014-07-15 20:08:07','6','2014-07-15 20:08:07','6'),(153,'BLR','46','Toshiba','25 TW',2007,30000,'N','LED','32',NULL,NULL,NULL,'2014-07-15 20:12:52','6','2014-07-15 20:12:52','6'),(154,'BLR','46','Toshiba','25 TW',2007,30000,'N','LED','32',NULL,NULL,NULL,'2014-07-15 20:18:36','6','2014-07-15 20:18:36','6'),(155,'BLR','46','Toshiba','25 TW',2007,30000,'N','LCD','32','Y','Y','Y','2014-07-15 20:21:23','6','2014-07-15 20:21:23','6');
...
INSERT INTO `post_details_washingmachine` VALUES (159,'BLR','108','Onida','25 TW',2007,30000,'N','2014-07-15 20:37:26','6','2014-07-15 20:37:26','6'),(162,'CHE','C6','Onida','25 TW',2007,30000,'N','2014-07-16 18:24:10','6','2014-07-16 18:24:10','6');
...
INSERT INTO `user_credentials` VALUES ('0',1,'shiva@infosys.com','test23','9999999999','0',NULL,NULL,'2014-06-22 11:09:22','SYSTEM','2014-06-22 11:09:22','SYSTEM'),('0',2,'sachin@corporate.com','test','9999977777','0',NULL,NULL,'2014-06-22 11:41:50','SYSTEM','2014-06-22 11:41:50','SYSTEM'),('0',3,'yoganand@cts.com','test123','9999911111','0','2014-06-26 21:40:54',NULL,'2014-06-22 11:46:44','SYSTEM','2014-06-26 21:40:54','3'),('0',4,'iiii@gmail.ccom','test','1231221232','0',NULL,NULL,'2014-06-22 13:48:03','SYSTEM','2014-06-22 13:48:03','SYSTEM'),('0',5,'gopi@tcs.com','test','9999944444','0',NULL,NULL,'2014-06-27 07:58:56','SYSTEM','2014-06-27 07:58:56','SYSTEM'),('0',6,'julies@cts.com','test','9999922222','0','2014-07-18 01:02:49',NULL,'2014-06-30 06:30:04','SYSTEM','2014-07-18 01:02:49','6');
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`shiva`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `television_posts` AS select `ptv`.`POST_ID` AS `POST_ID`,`ptv`.`CITY` AS `CITY`,`ptv`.`LOCATION` AS `LOCATION`,`ptv`.`BRAND` AS `BRAND`,`ptv`.`MODEL` AS `MODEL`,`ptv`.`YEAR` AS `YEAR`,`ptv`.`PRICE` AS `PRICE`,`ptv`.`BILL_AVAILABLE` AS `BILL_AVAILABLE`,`ptv`.`SCREEN_TYPE` AS `SCREEN_TYPE`,`ptv`.`SCREEN_SIZE` AS `SCREEN_SIZE`,`ptv`.`STABILIZER` AS `STABILIZER`,`ptv`.`USB` AS `USB`,`ptv`.`HDMI` AS `HDMI`,`ptv`.`CREATED_ON` AS `CREATED_ON`,`ptv`.`CREATED_BY` AS `CREATED_BY`,`ptv`.`MODIFIED_ON` AS `MODIFIED_ON`,`ptv`.`MODIFIED_BY` AS `MODIFIED_BY`,`poit`.`TITLE` AS `TITLE`,`poit`.`CONTACT_NO` AS `CONTACT_NO`,`poit`.`CONTACT_PERSON_NAME` AS `CONTACT_PERSON_NAME`,`poit`.`DESCRIPTION` AS `DESCRIPTION`,`poit`.`IMAGE_FILE_NAME` AS `IMAGE_FILE_NAME`,`poit`.`CORP_ID` AS `CORP_ID` from (`ptv` join `poit`) where (`poit`.`POST_ID` = `ptv`.`POST_ID`) */;
...
-- Dump completed on 2014-07-17 20:11:22
